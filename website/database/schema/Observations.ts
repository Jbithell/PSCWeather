...
export const observationFromWeatherStation = z.object({
  barTrend: z.string(),
  barometer: z.string(),
  temperatureF: z.string(),
  windSpeed: z.string(),
  windDirection: z.string(),
  wind10MinAverage: z.string(),
  wind2MinAverage: z.string(),
  windGust: z.string(),
  windGustDirection: z.string(),
  dewPoint: z.string(),
  humidity: z.string(),
  rainRate: z.string(),
  uv: z.string(),
  solarRadiation: z.string(),
  last15MinRain: z.string(),
  lastHourRain: z.string(),
  last24HourRain: z.string(),
